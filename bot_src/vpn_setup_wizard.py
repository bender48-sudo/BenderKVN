...
CHAT_STEPS_TEMPLATE = (
    ...
    "<b>2.</b> {config_step}\n"
    "<b>3.</b> В Happ: + → «Из буфера обмена» (или QR из «Подключить VPN» в боте).\n"
...
CONFIG_STEP_TRIAL = (
    "Получите настройку: «Начать бесплатно» в меню "
    "или «Настроить VPN», если ключ уже есть."
)
CONFIG_STEP_HAS_KEY = (
    "Откройте «Настроить VPN» — QR и ссылка для Happ."
)
