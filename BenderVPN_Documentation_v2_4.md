...
| Russia Relay | 72.56.0.145 | 3344 | Selectel | Ubuntu 22.04 |
...
> Имена, Telegram ID и subscription ключи пользователей НЕ хранятся
> в документации. Используйте Remnawave Panel UI или API
> `GET /api/users` для актуальных данных.
...
6. `balancer.sh` автоматически пересчитает capacity
