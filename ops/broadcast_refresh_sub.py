...
MESSAGE_HTML = (
    "<b>Техническое сообщение.</b> Был кратковременный сбой — у части пользователей подписка/доступ "
    "могли отображаться некорректно, из‑за этого VPN не подключался. Сейчас всё исправили.\n"
    "\n"
    "<b>Пожалуйста:</b>\n"
    "1) нажмите <b>«Обновить подписку»</b> в приложении / в профиле подписки\n"
    "2) затем <b>переподключитесь</b> (если не помогло — полностью закройте приложение и откройте снова)\n"
    "\n"
    "Если после обновления всё ещё не работает — напишите в поддержку с вашим email/ID."
)
