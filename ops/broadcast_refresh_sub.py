...
MESSAGE_HTML = (
    "<b>Обновление VPN (важно).</b> Мы улучшили маршрутизацию: подписка стала стабильнее "
    "(Instagram, Telegram и остальной трафик). Старую конфигурацию в приложении нужно подтянуть.\n"
    "\n"
    "<b>Пожалуйста:</b>\n"
    "1) <b>Обновите подписку</b> в Happ (кнопка обновления / pull)\n"
    "2) <b>Переподключите VPN</b> (выкл → вкл; при необходимости перезапустите Happ)\n"
    "\n"
    "Сервер выбирается автоматически — ничего вручную переключать не нужно.\n"
    "Если после этого Instagram или VPN всё ещё «то работает, то нет» — напишите в поддержку."
)
