...
| 3 | **Выбрал «Подключить VPN»** | Большая кнопка на главной | Та же кнопка на весь экран | Кнопка в меню / `/start` в чате |
| 4 | **Узнал, какое устройство** | «iPhone / Android / **Windows** / **Mac**» (4 кнопки) | То же | Вопрос с **четырьмя** кнопками (мастер) |
| 5 | **Установил Happ на это устройство** | Магазин для выбранной ОС; подсказка: «на телефоне и на компьютере — установите отдельно» | То же + «Открыть магазин» | Ссылка на App Store / Google Play / сайт Happ для Windows / Mac App Store |
