...
| 4 | **Узнал, какое устройство** | «У меня iPhone / Android / Windows» | То же | Вопрос с тремя кнопками (мастер) |
| 5 | **Установил приложение Happ** (или аналог) | Ссылка в App Store / Google Play + скрин | То же + «Открыть магазин» | Сообщение со ссылкой на магазин |
