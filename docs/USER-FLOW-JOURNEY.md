...
|---|----------------------------------------|-------------------------------------------|
| Шаг «какое устройство?» | **Да (Q039)** — «Подключить VPN» → **iPhone / Android / Windows / Mac** | **Да** — «Инструкция по устройству» на портале |
| Happ | Магазин **после** выбора ОС; профиль **BenderVPN Auto** (без ручного выбора узла) | То же + видео для iPhone/Android |
...
**Итог:** и в боте, и на портале — **явный** выбор из четырёх платформ. В Happ пользователь **не** выбирает NL/LV/turbo — только профиль **BenderVPN Auto** и обновление подписки (🔄).
