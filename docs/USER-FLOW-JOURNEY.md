...
| 4 | **Узнал, какое устройство** | «iPhone / Android / **Windows** / **Mac**» (4 кнопки) | То же | **As-is:** шага нет — сразу шаг 5 (две кнопки магазина). **To-be (Q039):** явный выбор + Win/Mac |
| 5 | **Установил Happ** | Магазин для выбранной ОС в портале | То же | **As-is:** **App Store** или **Google Play** под инструкцией (сам выбирает iOS/Android). Win/Mac — пока не в боте |
