...
| — | **NL-DIRECT-ROUTE-CLASS-FIX-001** | P0 | **PATH A — DONE (repo) / WAITING_OWNER_NL_DIRECT_BASIC_ROUTE_CLASS_SMOKE** | report(14): split partial, route classes + validator + smoke guard → [`NL-DIRECT-ROUTE-CLASS-FIX-2026-06-19.md`](NL-DIRECT-ROUTE-CLASS-FIX-2026-06-19.md) |
