...
| — | **NEW-INDEPENDENT-EXIT-PATH-001** | P0 | **OPEN (owner-gated)** | Procure an INDEPENDENT second exit/upstream (true path diversity; not the shared relay backend) per `VPN-ARCH-30K-CAPACITY-PLAN.md`; owner phrase: APPROVE NEW RELAY NODE PURCHASE TO REPLACE RELAY1 |
