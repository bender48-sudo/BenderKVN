...
| **CLIENT-SUBSCRIPTION-IMPORT-HAPP-001** | P1 | VPN client | Happ provider/geofile import noise | UnknownContentType; Google/Happ failed; Required value null | N/A | **After sleep/wake test** | Import UX vs reconnect | MOBILE-LOGS-2026-06-16 §4 | Happ client only | Correlate import errors with user-visible failure | log analyzer | No | **Yes** | — | **OPEN** |
