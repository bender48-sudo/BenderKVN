...
| [`INCIDENT-DIAG-2026-06-12-HAPP-TUN-ACTIVE-FAILURE.md`](INCIDENT-DIAG-2026-06-12-HAPP-TUN-ACTIVE-FAILURE.md) | CLIENT-STABILITY-ACTIVE-FAILURE — TUN up + routing directIp relay storm |
...
| **CLIENT-STABILITY-001** | P0 | VPN reliability | Windows Happ TUN daemon + Bender Proxy fallback | Track A: TUN daemon fails after sleep; Track B: Bender Proxy fails, other VPN Proxy works; **2026-06-12:** report(2) TUN up but **directIp→relay** error storm (INCIDENT-DIAG-2026-06-12) | N/A | **Now** | Desktop launch gate | Owner report + INCIDENT-DIAG-003-004 + **INCIDENT-DIAG-2026-06-12** | docs, `ops/diagnose_windows_vpn_resume.ps1`, `ops/analyze_happ_report_tun.py` | Track A/B/D/H documented; owner routing-OFF test; no prod change | CLIENT-SMOKE-001..003 | No | **Yes** | — | **OPEN** |
