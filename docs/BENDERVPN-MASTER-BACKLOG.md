...
| VPN-ARCH-001 | P1 | VPN architecture | Full VPN architecture audit | Selector/injectHosts mismatch; stealth split map | N/A | **Now** | Informed restore | `AUDIT-2026-06-09-VPN-ARCHITECTURE-DRYRUN.md` | ops/, panel | Dry-run complete; Candidate D recommended | AUDIT-002 done | No | **Yes** for apply | VPN-REL-001 | **AUDIT DONE** |
