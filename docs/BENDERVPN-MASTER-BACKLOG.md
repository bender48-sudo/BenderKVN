...
| **CLIENT-STABILITY-001** | P0 | VPN reliability | Windows Happ TUN daemon + Bender Proxy fallback | Track A: TUN daemon OPEN; Track B: Proxy OPEN; **Track D:** geoip:ru DirectIp fix — **owner local retest PASS 2026-06-12**; **prod happRouting deploy pending** | N/A | **Now** | Desktop launch gate | INCIDENT-DIAG-2026-06-12 §11.1 | docs, guard, `patch_happ_routing.py` | Prod apply after explicit approval; Track A/B smokes | CLIENT-SMOKE-001..003 | No | **Yes** | — | **OPEN** — Track D mitigated locally |
