...
| [`INCIDENT-DIAG-2026-06-12-HAPP-TUN-ACTIVE-FAILURE.md`](INCIDENT-DIAG-2026-06-12-HAPP-TUN-ACTIVE-FAILURE.md) | CLIENT-STABILITY-ACTIVE-FAILURE — TUN up + geoip:ru DirectIp leak; fix in `happ_routing_directip_guard.py` |
...
| **CLIENT-STABILITY-001** | P0 | VPN reliability | Windows Happ TUN daemon + Bender Proxy fallback | Track A: TUN daemon; Track B: Proxy; **Track D fix repo:** remove geoip:ru from Happ DirectIp — **owner retest pending** | N/A | **Now** | Desktop launch gate | INCIDENT-DIAG-2026-06-12 + guard | docs, `ops/happ_routing_directip_guard.py`, `ops/analyze_happ_report_tun.py` | Owner TUN retest routing ON; patch_happ_routing after approval | CLIENT-SMOKE-001..003 | No | **Yes** | — | **OPEN** — fix repo done |
