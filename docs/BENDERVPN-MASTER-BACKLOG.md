...
| — | **NL-INDEPENDENT-EXIT-TRAFFIC-SMOKE-AND-PROMOTION-001** | P0 | **FAIL / WAITING_RETEST** | Legacy profile FAIL; two-profile fix ready → [`NL-INDEPENDENT-EXIT-TRAFFIC-SMOKE-2026-06-18.md`](NL-INDEPENDENT-EXIT-TRAFFIC-SMOKE-2026-06-18.md) |
...
| — | **NL-INDEPENDENT-EXIT-FIX-001** | P0 | **DONE (repo) / WAITING_RETEST** | Split DIRECT_BASIC + SPLIT_STEALTH; validator catches google→stealth mismatch → [`NL-INDEPENDENT-EXIT-FIX-2026-06-18.md`](NL-INDEPENDENT-EXIT-FIX-2026-06-18.md) |
