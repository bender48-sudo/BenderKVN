...
| **CLIENT-SUBSCRIPTION-IMPORT-HAPP-001** | P1 | VPN client | Happ provider/geofile import noise | UnknownContentType; geofile failures; weak UX correlation in access window | N/A | **Parallel to observability** | Import UX vs reconnect | FULLDAY-DEEPDIVE §4–5 | Happ client read-only/staging | Staging content-type/import path review | fullday analyzer | No | **Yes** | — | **OPEN** |
...
| **CLIENT-MOBILE-OBSERVABILITY-001** | P0 | VPN reliability | Full-day mobile access_log export/capture | Access covers 1.4% of Jun 16 | N/A | **Now** | Blocks passive root-cause | FULLDAY-DEEPDIVE §2 checklist | owner phone | Export full-day access + sub same day | `--fullday` analyzer | No | **Yes** | FULLDAY-DEEPDIVE-001 | **OPEN** |
