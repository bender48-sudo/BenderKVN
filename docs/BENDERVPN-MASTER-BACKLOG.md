...
| **CLIENT-STABILITY-001** | P0 | VPN reliability | Windows Happ TUN recovery | Track D DirectIp **fixed**; TUN starts fast; **relay #1 long-connection reset** (report(6)); relay2 lab JSON ready | N/A | **Now** | Desktop launch gate | [CLIENT-STABILITY-HAPP-RECOVERY-CAPTURE.md](CLIENT-STABILITY-HAPP-RECOVERY-CAPTURE.md) | docs, analyzer, guard, relay2 lab gen (`d2bf8da`) | 30–60 min soak PASS → gate review | CLIENT-SMOKE-001..003 | No | **Yes** | LONG-SESSION-SOAK-001 | **OPEN** — soak pending |
| **CLIENT-STABILITY-HAPP-LONG-SESSION-SOAK-001** | P0 | VPN reliability | Happ Windows TUN long-session soak | report(6) relay #1 bias; Cursor/Docs degradation under TUN | N/A | **Now** | Desktop launch gate | recovery doc §9; report(6) local | owner laptop | 30–60 min; PASS/SOFT/FAIL table | analyze_happ_report_tun on FAIL | No | **Yes** | relay2 lab optional | **PENDING** — owner run |
