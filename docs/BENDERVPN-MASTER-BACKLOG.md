...
| **CLIENT-STABILITY-001** | P0 | VPN reliability | Windows Happ TUN recovery | Track D DirectIp **fixed**; TUN starts fast; **relay #1/#2 timeout/reset** (report(5)); clean capture required | N/A | **Now** | Desktop launch gate | [CLIENT-STABILITY-HAPP-RECOVERY-CAPTURE.md](CLIENT-STABILITY-HAPP-RECOVERY-CAPTURE.md) | docs, analyzer, guard | Clean Bender-only report → lab variants | CLIENT-SMOKE-001..003 | No | **Yes** | — | **OPEN** — recovery active |
