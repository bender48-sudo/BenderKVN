...
| **CLIENT-STABILITY-001** | P0 | VPN reliability | Windows Happ TUN recovery | Track D DirectIp **fixed**; TUN starts fast; relay2 lab report(7) **SOFT PASS** active session; **relay #1 remains strong suspect** (report(6)); sleep/wake **OPEN** | N/A | **Now** | Desktop launch gate | [CLIENT-STABILITY-HAPP-RECOVERY-CAPTURE.md](CLIENT-STABILITY-HAPP-RECOVERY-CAPTURE.md) · [relay2 lab §report(7)](CLIENT-STABILITY-HAPP-RELAY2-LAB.md) | docs, analyzer, guard, relay2 lab gen | Repeat 30–60 min relay2 soak without sleep → gate review | CLIENT-SMOKE-001..003 | No | **Yes** | LONG-SESSION-SOAK-001 | **OPEN** — gate not closed |
| **CLIENT-STABILITY-HAPP-LONG-SESSION-SOAK-001** | P0 | VPN reliability | Happ Windows TUN long-session soak | report(7) relay2 **SOFT PASS** (~43 min, sleep contaminated); report(6) relay #1 bias | N/A | **Now** | Desktop launch gate | recovery doc §9; report(6)/report(7) local | owner laptop | 30–60 min **without sleep**; PASS/SOFT/FAIL table | analyze_happ_report_tun on FAIL | No | **Yes** | relay2 lab optional | **PENDING** — repeat soak |
