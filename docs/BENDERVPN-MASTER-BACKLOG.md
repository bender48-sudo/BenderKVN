...
| — | **NL-INDEPENDENT-EXIT-TRAFFIC-SMOKE-AND-PROMOTION-001** | P0 | **WAITING_CLEAN_DIRECT_BASIC_SMOKE** | report(12) invalid smoke (wrong profile + RU overlay + TG); guard added → [`NL-INDEPENDENT-EXIT-TRAFFIC-SMOKE-2026-06-18.md`](NL-INDEPENDENT-EXIT-TRAFFIC-SMOKE-2026-06-18.md) |
