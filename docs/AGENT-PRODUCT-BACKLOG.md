...
**Gate:** применять **после закрытия Q078**. Пока **`NEXT`** = **Q063–Q078** — см. **`docs/AUDIT-2026-05-SECURITY.md`**.

**NEXT в блоке продукта:** **Q051** (**P2-RED-EDGE-PORT-01**) — станет активным, когда security **Q078** = DONE.
