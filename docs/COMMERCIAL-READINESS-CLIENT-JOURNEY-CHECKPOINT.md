...
| **2nd INDEPENDENT exit (NL)** | **PATH A — candidate validated, owner smoke pending** | [`NEW-INDEPENDENT-EXIT-PATH-2026-06-17.md`](NEW-INDEPENDENT-EXIT-PATH-2026-06-17.md): NL = real remnanode VLESS/REALITY exit, egress `ep_2a1adf7b` independent of LV/RU upstream; **INDEPENDENT_EXIT_PATH_V1** + `independent_exit_paths=1` (honest); owner phrase **APPROVE NL INDEPENDENT EXIT TRAFFIC SMOKE** → then `delivery_path_nodes=2` |
