...
| **2nd INDEPENDENT exit (NL)** | **PATH A — WAITING_OWNER_NL_DIRECT_BASIC_ROUTE_CLASS_SMOKE** | [`NL-DIRECT-ROUTE-CLASS-FIX-2026-06-19.md`](NL-DIRECT-ROUTE-CLASS-FIX-2026-06-19.md): report(14) split partial (stealth alive, NL direct/blocked fail); explicit route classes + validator; run DIRECT_BASIC route-class smoke first |
