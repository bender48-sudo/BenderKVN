...
| **2nd INDEPENDENT exit (NL)** | **PATH A — candidate validated; traffic smoke WAITING** | [`NEW-INDEPENDENT-EXIT-PATH-2026-06-17.md`](NEW-INDEPENDENT-EXIT-PATH-2026-06-17.md) + [`NL-INDEPENDENT-EXIT-TRAFFIC-SMOKE-2026-06-18.md`](NL-INDEPENDENT-EXIT-TRAFFIC-SMOKE-2026-06-18.md): runbook in `.local/independent_exit_nl_canary.*`; owner must RUN smoke and report PASS before canary promotion |
