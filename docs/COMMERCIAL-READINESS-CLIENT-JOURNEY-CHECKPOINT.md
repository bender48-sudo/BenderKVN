...
| **2nd INDEPENDENT exit (NL)** | **PATH B — WAITING_CLEAN_DIRECT_BASIC_SMOKE** | [`NL-DIRECT-PATH-SERVER-PROFILE-FIX-2026-06-18.md`](NL-DIRECT-PATH-SERVER-PROFILE-FIX-2026-06-18.md): report(13) NL-direct REALITY `sockopt.fragment` defect fixed in client builder (stealth alive, sites dead); reports 12/13 overlay-contaminated; run clean Direct Basic with guard |
