...
**Правило (по умолчанию):** одна строка **NEXT**; один Q → один коммит → стоп.

**Непрерывный режим:** если владелец пишет «весь бэклог без остановки» / «до Q097» — выполнять **Q086–097** подряд; стоп только при блокере, ошибке verify или явном комментарии.
