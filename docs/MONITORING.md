...
**Deploy на LV:** `50a6ac4` (2026-06-11) + **MONITOR-FLAP-TUNE-001** `21f5a97` (2026-06-13 16:41 UTC). Extended soak **PASS** 2026-06-24 — window **2026-06-13 16:46:40 UTC → 2026-06-23 21:30 UTC** (~10d); `quorum_fail_cdn=0`; microsoft sustained TG ~6/10d accepted as design. `ru-monitor.py` unchanged. Evidence: [`CHECKPOINT-2026-06-12-CLIENT-NODES-MONITORING.md`](CHECKPOINT-2026-06-12-CLIENT-NODES-MONITORING.md) §10.
