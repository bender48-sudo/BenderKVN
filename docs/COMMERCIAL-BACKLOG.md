...
**Что делать сейчас:** **`docs/BACKLOG-QUEUE.md`** — **`NEXT=Q036`** (**P3-FLOW-02** setup page). Ручные хвосты: **`docs/MANUAL-OWNER-CHECKLIST.md`**.

**Открыто (продукт):** **P5-COM-02**, **P3-FLOW-02…13**; bootstrap **`/start`** на проде. **P5-ENG-01**.
