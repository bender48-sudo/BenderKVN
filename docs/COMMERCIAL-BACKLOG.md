...
| Дата | Что сделано |
|------|-------------|
| 2026-05-16 | **P2-RED-BOOT-01 — DONE:** HTTPS mirror **`/api/ops/status.json`** на **k9x2m1** (Caddy file_server + cron ***/2**); **`smoke_status_channels.py`** → **STATUS_CHANNELS_OK**; § в **`RUNBOOK-INCIDENT`**. **NEXT=Q021** P2-RED-TLS-01. |
