...
| Дата | Что сделано |
|------|-------------|
| 2026-05-16 | **P6-SCALE-04 (c) — DONE:** после edge RL (**(b)**) — **`subscription_load_probe`** **total=120**, **concurrency=30** на probe URL (рабочая станция): **120×200**, **p95≈1.83s**, **p50≈1.12s**, **hard_errors=0**, **bad_http_rate=0**; **429/5xx=0**. Эпик **P6-SCALE-04** закрыт (a)(b)(c). **NEXT=Q004** restore test. |
...
| 2026-05-16 | **Последовательная очередь:** **`docs/BACKLOG-QUEUE.md`** (Q001…Q003 **DONE**, **NEXT=Q004** P2-OPS-RESTORE-TEST-01), **`docs/POLICY-SEQUENTIAL-WORK.md`**, **`.cursor/rules/sequential-backlog.mdc`**. |
