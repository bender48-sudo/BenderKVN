...
| ID | Задача | Где | Verify | Статус |
|----|--------|-----|--------|--------|
| Q-UX-011 | Orphan handlers: `show_referrals` → `invite_friend` | handlers.py | callback | ✅ |
...
| Q-UX-014 | Ошибки trial: inline «Написать в поддержку» | handlers | симуляция down | ✅ |
...
## Порядок работ (закрыто 2026-05-19)

Все Q-UX-001…020 закрыты в ветке `audit/coderabbit-user-flows-2026-05`. Деплой: AMS bot + LV portal.
