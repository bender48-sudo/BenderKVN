...
**Capacity math (2026-06-11, PROOF-001):**

- **Do not count** paid, connected, failover-ready, or backup-edge servers as **active capacity** unless they appear in **generated profiles/routing** and pass quality/soak gates.
...
- **VPN-ARCH-001** — **PROOF-001 DONE** (2026-06-11): NL not normal Auto capacity; owner decision A/B/C/D pending; **VPN-AUD-220** historical DONE is insufficient (not **NODE-NL-REVALIDATE-001**)
