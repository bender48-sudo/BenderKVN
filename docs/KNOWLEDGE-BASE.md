...
| **Что делать сейчас (один NEXT)** | **`docs/BACKLOG-QUEUE.md`** — **NEXT=—**; фаза 11 ✅ (**Q167–171**); VPN-AUD-210+ или **Q032** (владелец) |
...
| Очередь агента (сейчас) | **`docs/BACKLOG-QUEUE.md`** — фаза 8 **Q122–141 DONE**; **NEXT** — **Q120** / **Q032** (владелец) |
