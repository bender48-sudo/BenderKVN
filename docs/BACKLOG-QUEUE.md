...
**NEXT:** **—** (фаза 15 **VPN-AUD-280** ✅). Параллельно: **Q032**, **O-VPN-009**, **O-VPN-002**.
...
### Фаза 15 — post relay-NL inject (2026-06-04)
...
**NEXT:** **—**. **O-VPN-002** smoke (владелец).

### Фаза 13 — NL полноценная нода · 3-я prod · ёмкость (2026-06-04)

**Контекст:** [`docs/AGENT-PHASE13-NL-SCALE-BACKLOG.md`](AGENT-PHASE13-NL-SCALE-BACKLOG.md), [`docs/CAPACITY-AND-FAILOVER-ROADMAP.md`](CAPACITY-AND-FAILOVER-ROADMAP.md).

| Q | ID | Статус | Done when (кратко) | Verify | Commit (пример) |
|---|-----|--------|-------------------|--------|-----------------|
| 174 | **VPN-AUD-271** | **DONE** | `nl_node_health_probe.py`; panel baseline | **NL_NODE_HEALTH_OK** panel | `ops: VPN-AUD-271 — NL health probe` |
...
**Параллельно (владелец):** **Q032**, **O-VPN-009** (IP 3-й ноды).
