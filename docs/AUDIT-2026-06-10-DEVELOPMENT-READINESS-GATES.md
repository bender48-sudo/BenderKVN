...
|------|-------------|--------|
| **G2-A** | Web `ref_code` → `referred_by` end-to-end | E2E web trial **PASS**; TG bind **FAIL** — zero `funnel_bot_start bind:*` on AMS; bind entry path audit: [`AUDIT-2026-06-10-TELEGRAM-BIND-FLOW.md`](AUDIT-2026-06-10-TELEGRAM-BIND-FLOW.md) |
