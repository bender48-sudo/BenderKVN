...
| **G2-G** | Cabinet API active config count/list (read-only) | **P1-DEV-001 in repo 2026-06-10** — `active_config_count`, `configurations[]`, anomaly flags; `tests/test_portal_cabinet_billing.py` PASS; **not deployed** |
