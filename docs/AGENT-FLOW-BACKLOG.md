# Бэклог флоу для агента Cursor (фаза 3, Q032+)

**Назначение:** пошаговые инструкции для **автономного** закрытия пользовательского флоу.  
**Очередь (один NEXT):** **`docs/BACKLOG-QUEUE.md`**.  
**Контекст продукта:** **`docs/USER-FLOW-BACKLOG.md`**, §7.1 **`docs/COMMERCIAL-BACKLOG.md`**.

---

## 0. Правила для агента

1. Взять **только** строку **`NEXT`** из **`BACKLOG-QUEUE.md`**.
...
**Текущий NEXT:** **`BACKLOG-QUEUE.md`** → **Q043** (**P3-FLOW-08**). Карта: **`BACKLOG-MAP.md`**.
