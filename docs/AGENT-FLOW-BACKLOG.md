...
> **Gate:** пока не закрыт **Q062**, **NEXT** = продукт (**Q051–062**). Инструкции: **`docs/AGENT-PRODUCT-BACKLOG.md`**. **Не начинать Q044**, если в **`BACKLOG-QUEUE.md`** NEXT ещё в диапазоне 051–062.
