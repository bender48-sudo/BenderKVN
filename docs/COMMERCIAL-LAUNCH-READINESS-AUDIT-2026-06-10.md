...
|------|------|--------|----------|---------------|---------------|---------------|-----------------|----------------|
| **G1** | VPN stability / Happ / sleep-resume / browser SaaS / **CLIENT-STABILITY** | **PARTIAL** | Track A sleep **OPEN**; DirectIp fix deployed; report(7) relay2 **SOFT PASS** + report(8) repeat active **PASS**; **[PROD-SELECTOR-CONTROLLED-001 eligible — not auto-approved](CLIENT-STABILITY-HAPP-RELAY2-LAB.md#client-stability-happ-relay2-prod-selector-controlled-001--recommended-if-repeat-passsoft-pass)**; mobile smoke **PENDING** | Desktop + mobile work = **yes** | **Yes** if desktop/mobile sold | **Yes** | CLIENT-SMOKE-001 + mobile smoke + owner approval for prod selector | Waive desktop/SaaS/mobile support? |
